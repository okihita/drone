        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center justify-between px-1">
              ...
              <Button variant="ghost" size="sm" onClick={fetchStagedItems} className="text-sm h-7 rounded-[4px]">
                    ...
                    >
                      <div className="flex items-stretch min-h-[92px]">
                        ...
                        {item.image_url && item.image_url.trim() ? (
                          ...
                          <div className="w-36 sm:w-40 shrink-0 aspect-[16/9] self-center bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-sm text-slate-400 font-medium">
                            No Image
                          </div>
                        )}
                        ...
                        <div className="min-w-0 flex-1 p-3.5 space-y-2 flex flex-col justify-between">
                          <h3 className="font-serif-editorial text-sm sm:text-sm font-bold text-slate-900 dark:text-white leading-snug line-clamp-2">
                            {item.title}
                          </h3>
                          <div className="flex flex-wrap items-center justify-between gap-1 text-sm text-slate-500 font-sans">
                            <span>{item.published_date}</span>
                            <Badge variant="outline" className="text-sm py-0 px-1.5 rounded-[2px]">
                              {item.jurisdiction}
                            </Badge>
                          </div>
                        </div>
              ...
              <Card className="border-slate-200 dark:border-slate-800 shadow-md rounded-[4px]">
                <CardHeader className="border-b bg-slate-50/50 dark:bg-slate-900/50 py-3.5 px-6 flex flex-row items-center justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center text-sm text-asean-blue hover:underline font-medium"
                  >
                ...
                <CardContent className="p-6 space-y-6">
                  {/* Title Editor */}
                  <div>
                    <label className="text-sm font-bold text-slate-500 uppercase tracking-wider block mb-1.5">
                      Article Title
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3 bg-slate-100/60 dark:bg-slate-950/60 rounded-[4px] text-sm font-sans">
                  ...
                  <div>
                    <label className="text-sm font-bold text-slate-500 uppercase tracking-wider flex items-center justify-between mb-2">
                      <span className="flex items-center gap-1.5">
                        <Globe className="w-3.5 h-3.5 text-asean-blue" /> Target Jurisdictions (Multi-Select)
                      </span>
                      <span className="text-sm text-asean-blue font-semibold normal-case">
                      ...
                      {JURISDICTIONS.map((j) => {
                        ...
                        return (
                          <button
                            ...
                            className={`text-sm py-1 px-2.5 rounded-[3px] transition-all font-medium border ${
                              isChecked
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-slate-50 dark:bg-slate-900/60 p-4 rounded-[4px] border border-slate-100 dark:border-slate-800">
                    <div>
                      <label className="text-sm font-semibold text-slate-500 flex items-center gap-1 mb-1">
                      ...
                      <select
                        ...
                        className="w-full p-2 text-sm border rounded-[4px] bg-white dark:bg-slate-900 font-medium"
                      >
                        {CATEGORIES.map((c) => (
                  ...
                  <div className="space-y-2 pt-2 border-t">
                    ...
                    {(() => {
                      ...
                      return htmlContent ? (
                        ...
                        <div className="p-4 rounded-[4px] bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-sm text-slate-500 italic">
