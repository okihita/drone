    ...
    <PageShell>
      ...
      <main className="flex-1 py-10 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full font-sans">
        ...
        <div className="border-b border-slate-200 dark:border-slate-800 pb-6 mb-8 font-sans">
          <span className="inline-block rounded-full border border-asean-yellow/50 bg-asean-yellow/15 px-3 py-0.5 text-[11px] font-sans font-bold text-asean-yellow-dark dark:text-asean-yellow mb-2 uppercase tracking-wider">
