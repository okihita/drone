...
export default function D2DSubNav() {
  ...
  return (
    <div
      className="sticky top-[calc(var(--drone-admin-bar-h,0px)+var(--drone-header-h,105px))] z-30 border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md animate-[slideDown_0.25s_ease-out]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-start sm:justify-center gap-1 py-2 overflow-x-auto no-scrollbar">
