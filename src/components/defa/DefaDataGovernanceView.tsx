    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-200 font-sans">
      ...
      <section className="relative border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 py-10 sm:py-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs font-sans uppercase tracking-widest text-asean-blue font-bold">
            <Globe className="h-4 w-4 text-asean-blue animate-pulse" />
            <span>DEFA Chapter 2 Observatory</span>
            <span>·</span>
            <span className="text-slate-500 font-mono">DFFT vs Domestic Localization</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-3xl font-sans leading-relaxed">
            Evaluating the 3-tier regulatory spectrum across all 11 ASEAN nations—balancing Data Free Flow with Trust (DFFT) against domestic server localization decrees and citizen privacy protection.
          </p>
        </div>
      </section>
