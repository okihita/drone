        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full bg-asean-amber/15 text-asean-amber border border-asean-amber/30 text-[10px] font-mono font-bold">
        ...
        <div className="space-y-6 pt-2 text-xs font-sans leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1.5">
              <span className="font-mono text-[10px] uppercase font-bold text-asean-blue">1. The Treaty &amp; Vision</span>
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1.5">
              <span className="font-mono text-[10px] uppercase font-bold text-asean-emerald">2. $2 Trillion Economic Scale</span>
              <p className="text-slate-700 dark:text-slate-300">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1.5">
              <span className="font-mono text-[10px] uppercase font-bold text-asean-amber">3. July 2026 Milestone</span>
              <p className="text-slate-700 dark:text-slate-300">
