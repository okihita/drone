    ...
    <section className="px-4 sm:px-6 lg:px-8 py-10 border-t border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/40">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
          {top3.map((s, i) => (
            <div key={s.countryCode} className="p-3 rounded-lg border border-emerald-200 dark:border-emerald-800 bg-emerald-50/50 dark:bg-emerald-950/20">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-sm font-extrabold text-emerald-600 dark:text-emerald-400">{s.overallScore}/100</span>
              </div>
              <div className="mt-1.5 h-1.5 rounded-full bg-slate-200 dark:bg-slate-700">
                <div className="h-full rounded-full bg-emerald-600 dark:bg-emerald-500" style={{ width: `${s.overallScore}%` }} />
              </div>
            </div>
          ))}
        </div>
