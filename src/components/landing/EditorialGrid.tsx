    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-b border-slate-200 dark:border-slate-800">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6 lg:border-r lg:border-slate-200 lg:dark:border-slate-800 lg:pr-8 animate-fade-up">
          <span className="text-sm font-sans uppercase tracking-widest text-asean-yellow font-bold block">
            {insights.kebab}
          </span>
          <h3 className="font-serif-editorial text-2xl font-bold text-slate-900 dark:text-white leading-tight">
            {insights.heading}
          </h3>
          <p className="text-sm sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-sans">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm font-sans font-bold text-asean-yellow hover:underline pt-2"
          >
        ...
        <div className="lg:col-span-4 space-y-6 lg:border-r lg:border-slate-200 lg:dark:border-slate-800 lg:pr-8 animate-fade-up [animation-delay:150ms]">
          <span className="text-sm font-sans uppercase tracking-widest text-asean-blue font-bold block">
            02 • FIELD DISPATCHES
          </span>
          {dispatches.map((d, idx) => (
            ...
            >
              ...
              <span className="text-sm font-sans text-asean-yellow font-bold uppercase">
                {d.category}
              </span>
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm line-clamp-2 leading-relaxed font-sans">
        ...
        <div className="lg:col-span-3 space-y-6 animate-fade-up [animation-delay:300ms]">
            ...
            {radar.map((entry) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="font-serif-editorial font-bold text-sm text-slate-900 dark:text-white leading-snug">
                    {entry.title}
                  </h4>
                  <span className="text-sm text-slate-500 dark:text-slate-400 block font-sans">
                    {entry.date}
                  </span>
                </div>
              );
          ...
          <Link
            href="/ledger"
            className="inline-flex items-center gap-1.5 text-sm font-sans font-bold text-asean-blue hover:underline pt-2"
          >
