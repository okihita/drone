      ...
      {stats.map((pill, idx) => (
        <div key={pill.label} className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="block font-sans text-[10px] text-slate-400 uppercase font-bold">{pill.label}</span>
  ...
  return (
    <section className="relative border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 py-6 sm:py-9 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {howToRead && (
          <p className="text-xs text-slate-400 dark:text-slate-500 max-w-3xl font-sans leading-relaxed">
