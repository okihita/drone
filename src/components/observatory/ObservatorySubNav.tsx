...
import { OBSERVATORY_SUBMENU } from "@/lib/constants";

export default function ObservatorySubNav() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center gap-1.5 py-2 overflow-x-auto no-scrollbar">
        {OBSERVATORY_SUBMENU.map((item) => {
