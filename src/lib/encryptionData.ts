...
const ENCRYPTION_EVENTS: EncryptionEvent[] = [
  // ── Myanmar ──
  {
    ...
    sourceUrl: "https://www.accessnow.org/publication/myanmar-cybersecurity-law/",
  ...
  // ── Vietnam ──
  {
    ...
    sourceUrl: "https://vanban.chinhphu.vn/?pageid=27160&docid=206381",
  ...
  },
  {
    ...
    sourceUrl: "https://vanban.chinhphu.vn/?pageid=27160&docid=194165",
  ...
  },
  {
    ...
    sourceUrl: "https://mic.gov.vn/du-thao-van-ban-quy-pham-phap-luat.htm",
  ...
  // ── Indonesia ──
  {
    ...
    sourceUrl: "https://peraturan.bpk.go.id/Details/162817/pm-kominfo-no-5-tahun-2020",
  ...
  },
  {
    ...
    sourceUrl: "https://www.bssn.go.id/standar-kriptografi-nasional/",
  ...
  // ── Cambodia ──
  {
    ...
    sourceUrl: "https://www.mptc.gov.kh/en/documents/sub-decrees/sub-decree-on-national-internet-gateway/",
  ...
  // ── Thailand ──
  {
    ...
    sourceUrl: "https://www.etda.or.th/th/Useful-Resource/knowledge-sharing/articles/Computer-Crime-Act.aspx",
  ...
  // ── Philippines ──
  {
    ...
    sourceUrl: "https://cicc.gov.ph/cybercrime-prevention-framework/",
  ...
  // ── Singapore ──
  {
    ...
    sourceUrl: "https://www.csa.gov.sg/News-Events/News/asean-singapore-cybersecurity-centre-of-excellence",
  ...
  // ── Malaysia ──
  {
    ...
    sourceUrl: "https://www.nacsa.gov.my/guidelines.php",
