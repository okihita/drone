...
const NEGOTIATION_MILESTONES: NegotiationMilestone[] = [
  ...
  },
  {
    ...
    description: "Legal review and text scrubbing of agreed DEFA chapters following conclusion of negotiations at 57th SEOM Manila.",
    milestoneDate: "2026-06-01", endDate: "2026-10-31", status: "IN_PROGRESS",
    countries: ["SG", "MY", "ID", "TH", "PH", "VN", "BN", "KH", "LA", "MM"],
    sourceUrl: "https://asean.org",
  },
  {
    id: "defa-005", framework: "DEFA",
    title: "Expected DEFA Signing Ceremony (49th ASEAN Summit)",
    description: "Anticipated formal signing of the Digital Economy Framework Agreement by ASEAN Leaders at the 49th ASEAN Summit in November 2026.",
    milestoneDate: "2026-11-15", status: "UPCOMING",
    countries: ["SG", "MY", "ID", "TH", "PH", "VN", "BN", "KH", "LA", "MM"],
    sourceUrl: "https://asean.org",
  },
  {
    id: "defa-006", framework: "DEFA",
    title: "DEFA Ratification Window (National Parliaments)",
    description: "Individual ASEAN member states initiate domestic ratification processes for DEFA ahead of expected 2027 entry into force.",
    milestoneDate: "2027-01-01", endDate: "2028-12-31", status: "UPCOMING",
    countries: ["SG", "MY", "ID", "TH", "PH", "VN", "BN", "KH", "LA", "MM"],
    sourceUrl: "https://asean.org",
  },
